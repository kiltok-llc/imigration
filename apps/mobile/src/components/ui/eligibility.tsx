...
export const useEligibilityQuizRoutes = () => useRequiredContext(EligibilityQuizRoutesContext);

export function EligibilityQuiz(
  {
    children,
  }: {
    children: ReactElement<EligibilityQuizPageProps> | ReactElement<EligibilityQuizPageProps>[];
  },
) {
...
export function EligibilityQuizPage({ children }: PropsWithChildren<EligibilityQuizPageProps>) {
  return (
    <QuizContents>
      {children}
    </QuizContents>
