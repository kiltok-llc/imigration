...
import { quizPageAtomFamily, useQuizPageAtomKey } from '@/lib/quiz/page';
...
export function QuizForm<Input extends FieldValues, Output>({
  children,
  defaultValues,
  formOptions = {},
  onSubmit = () => true,
  ...
  const valuesAtom = quizFormAtom(useQuizPageAtomKey()) as PrimitiveAtom<Input>;
